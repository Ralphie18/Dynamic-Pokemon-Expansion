...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_RIOLU] =            {{EVO_FRIENDSHIP, 0, SPECIES_LUCARIO, 0}},
	...
	[SPECIES_CRABRAWLER] =       {{EVO_MAP, MAPSEC_FROST_MOUNTAIN, SPECIES_CRABOMINABLE, 0},
								  {EVO_MAP, MAPSEC_ROUTE_8, SPECIES_NONE, 0},
								  {EVO_MAP, MAPSEC_BLIZZARD_CITY, SPECIES_NONE, 0},
								  {EVO_MAP, MAPSEC_FROZEN_FOREST, SPECIES_NONE, 0}},
